...
@php
    $page_title = $aRow ? 'Edit Asset Type' : 'Add New Asset Type';
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        @if ($aRow)
                        {{Form::open(array('url' =>route('admin.asset-type.update',$aRow->id), 'method' => 'post', 'files' => true))}}
                            @method('PATCH')
                        @else
                        {{Form::open(array('url' =>route('admin.asset-type.store'), 'method' => 'post', 'files' => true))}}
                        @endif
