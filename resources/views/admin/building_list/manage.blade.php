...
@php
    $page_title = $aRow ? 'Edit Building' : 'Add New Building';
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        @if ($aRow)
                            {{Form::open(array('url' =>route('admin.building.update',$aRow->id), 'files' => true))}}
                            @method('PATCH')
                        @else
                            {{Form::open(array('url' =>route('admin.building.store'), 'method' => 'post', 'files' => true))}}
