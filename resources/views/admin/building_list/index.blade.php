...
@php
    ...
    $add_new_url = route('admin.building.create');
@endphp
@section('title')
    {{ $page_title }}
@endsection
                        ...
                        <tbody>
                            @foreach ($aRows as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                        <a href="{{ route('admin.building.edit', $item->id) }}" class="btn btn-primary  btn-xs" title="Edit"><i class="fa fa-edit"></i> </a>
                                        <form action="{{ route('admin.building.destroy',$item->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
