...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <table>
                                    <tr>
                                        <th rowspan="4" class="pr-2 w-0">
                                            <div class="border_right pr-2">
                                                ...
                                                @else
                                                {!! QrCode::generate(url('user/qrcode/'.base64_encode($asset->unique_id))) !!}
                                                @endif
                                            </div>
                                        </th>
                                        @if(isset($asset->building->code))
                                    ...
                                    @endif
                                    @if(isset($asset->asset_type->name))
                                    <tr class="pl-2" >
                                        <th>Type:</th>
                                        <td>{{$asset->asset_type->name}}</td>
                                    </tr>
                                    @endif
                                    @if(isset(json_decode($asset->asset_json)->asset_name))
                                    <tr class="pl-2" >
                                        <th>Name:</th>
            ...
            {{-- {{ url('user/qrcode/'.base64_encode($asset->unique_id)) }} --}}
        </section>
        <!-- /.content -->
    </div>
    <!-- /.content-wrapper -->
