                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6 mb-sm-0 mb-2">
                            <div class="form-group">
                                ...
                                {!! Form::select('status',['' => 'Select'] + $leadObj::$status,$aQuery['status'] ?? '',['class' => 'form-control']) !!}
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" name="paginate" class="form-control" value="{{ $aQuery['paginate'] ?? '' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
