...
@php
    $page_title = $aRow ? 'Edit Floor' : 'Add New Floor';
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        @if ($aRow)
                           {{Form::open(array('url' =>route('admin.floors.update',$aRow->id), 'files' => true))}}
                            @method('PATCH')
                        @else
                            {{Form::open(array('url' =>route('admin.floors.store'), 'method' => 'post', 'files' => true))}}
                        @endif
