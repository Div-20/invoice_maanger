...
$collapse_toggle = 'toggle_id_string_demo2';
...
$clone_counter = isset($clone_counter) ? $clone_counter : 200;
@endphp
<div class="input-content">
    <div class="d-flex w-100 justify-content-between dynamic-form-heading">
        <a href="#{{$collapse_toggle}}" class="info-box-text text-muted dynamic-collapse-target" data-toggle="collapse">
            <i class="fa fa-caret-down mr-2" aria-hidden="true"></i><span class="">{{$dynamic_form_obj::$input_type_labels[$dynamic_form_obj::TYPE_RADIO]}}</span>
        </a>
    ...
    <div id="{{$collapse_toggle}}" class="collapse-panel-box collapse dynamic-collapse-target">
        <input type="hidden" class="form-control change_input_index" name="form_data[{{$input_form_name}}][input_type]" value="{{$dynamic_form_obj::TYPE_RADIO}}">
        ...
        <div class="form-group">
            <label>Default checked value <br><span class="text-danger">(Note: Option value to save and default value should be same)</,span></label>
            <input type="text" class="form-control change_input_index"  value="{{$input_data['default'] ?? ''}}" name="form_data[{{$input_form_name}}][default]" placeholder="Default selected value">
        </div>
            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <div class="justify-content-between d-flex p-0">
                        <label class="float-left p-0">Add Radio button Options</label>
                        ...
                        <div class="card" >
                            <div class="card-header">
                                <div class="justify-content-between d-flex">
                                    <h5 class="m-0">Radio Options</h5><button type="button" data-parent=".sortable-disabled" class="btn btn-danger btn-sm remove-clone-btn">Remove</button>
                                </div>
                            </div>
                            <div class="card-body">
