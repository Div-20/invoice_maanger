                    ...
                    <div class="col-sm-6">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mx-0">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{-- <input type=" text" class="form-control" readonly value="{!! $helperObj::parseCurrency($aRow->wallet->actualBalance()) !!}"> --}}
                                        </div>
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Fetch Location</label>
                                    <div class="row">
                                        <div class="col-sm-4"><input type="text" class=" form-control @error('location') is-invalid @enderror" name='lat' id="lat" placeholder="lat" value="{{ $aRow->location[0] ?? old('lat') }}"></div>
                                        <div class="col-sm-4"><input type="text" class=" form-control @error('location') is-invalid @enderror" name='long' id="long" placeholder="long" value="{{ $aRow->location[1] ?? old('long') }}"></div>
                                        <div class="col-sm-4"><button class="btn btn-info" type="button" id="locationBtn"><i class="fa fa-map-marker mr-2"></i> <b id="btnText">Add Location</b> </button></div>
                                    </div>
                                    @error('location')
                                        <label class="col-form-label" for="inputError"><i class="fa fa-times-circle text-danger "></i>&nbsp;&nbsp;{{ $message }}</label>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <label>Address</label>
                                    <textarea class="form-control @error('address') is-invalid @enderror" rows="3" id="inputError" name="address" placeholder="Enter Full Address">{{ $aRow->address ?? old('address') }}</textarea>
                                    @error('address')
                                        <label class="col-form-label" for="inputError"><i class="fa fa-times-circle text-danger "></i>&nbsp;&nbsp;{{ $message }}</label>
                                    @enderror
                                </div>
