...
@php
    $page_title = 'CMS';
    $add_new_url = route('admin.cms.create');
@endphp
@section('title')
    {{ $page_title }}
@endsection
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <input type="hidden" name="tagName" value="manage_cms">
                <div class="card-body p-0" style="display: block;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.cms.edit',$item->id) }}" class="btn btn-primary  btn-sm"><i class="fa fa-edit"></i> Edit</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
